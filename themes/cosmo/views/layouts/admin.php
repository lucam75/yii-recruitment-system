...
<html lang="en">
  ...
  Yii::app()->clientScript->registerCoreScript('jquery');
    ...
    $cs->registerScriptFile(Yii::app()->baseUrl . '/js/admin.js');
      ...
      <div class="navbar navbar-default" style="margin-bottom:1px;">
        ...
        <div class="navbar-collapse collapse navbar-responsive-collapse">
          <ul class="nav navbar-nav menu visible-xs">
            <li><?php echo CHtml::link('<i class="fa fa-list-alt"></i> '.Yii::t('app','Changelog'),array('Administrator/Changelog')); ?></li>
            <li><?php echo CHtml::link('<i class="fa fa-bar-chart-o"></i> '.Yii::t('app','Statistics'),array('Administrator/Statistics')); ?></li>
            <li><?php echo CHtml::link('<i class="fa fa-comments"></i> '.Yii::t('app','Admin Templates'),array('Administrator/Templates')); ?></li>
          </ul>
      ...
      <div class="row">
        <div class="col-md-2">
          <div class="btn-group btn-group-vertical menuV hidden-xs">
            ...
            <?php echo CHtml::link('<i class="fa fa-list-alt"></i> '.Yii::t('app','Changelog'),array('Administrator/Changelog'),array('class'=>'btn btn-default')); ?>
            <?php echo CHtml::link('<i class="fa fa-bar-chart-o"></i> '.Yii::t('app','Statistics'),array('Administrator/Statistics'),array('class'=>'btn btn-default')); ?>
            <?php echo CHtml::link('<i class="fa fa-comments"></i> '.Yii::t('app','Admin Templates'),array('Administrator/Templates'),array('class'=>'btn btn-default')); ?>
          </div>
        </div>
        <div class="col-md-10">
          <?php echo $content; ?>
